...
ms.locfileid: "884997"
---
# <a name="export"></a><span data-ttu-id="0242d-103">Eksportimine</span><span class="sxs-lookup"><span data-stu-id="0242d-103">Export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="0242d-104">See leht on jaotises arendus.</span><span class="sxs-lookup"><span data-stu-id="0242d-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="0242d-105">Kõigi toodete eksportimine</span><span class="sxs-lookup"><span data-stu-id="0242d-105">Export All Products</span></span>
<span data-ttu-id="0242d-106">Eksportige kõik tooted ilma filtrita.</span><span class="sxs-lookup"><span data-stu-id="0242d-106">Export all products without any filters.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="0242d-107">Kõigi toodete eksportimine</span><span class="sxs-lookup"><span data-stu-id="0242d-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-category"></a><span data-ttu-id="0242d-108">Toodete eksportimine kategooria järgi</span><span class="sxs-lookup"><span data-stu-id="0242d-108">Export Products by Category</span></span>
<span data-ttu-id="0242d-109">Valige eksportimiseks rühmitamine.</span><span class="sxs-lookup"><span data-stu-id="0242d-109">Select a grouping to export:</span></span>
...
## <a name="export-products-by-end-of-support-year"></a><span data-ttu-id="0242d-167">Toodete eksportimine toetuse aasta lõpul</span><span class="sxs-lookup"><span data-stu-id="0242d-167">Export Products by End of Support Year</span></span>
<span data-ttu-id="0242d-168">Valige aasta, et eksportida tooted, mis lõpevad teenusega sel aastal.</span><span class="sxs-lookup"><span data-stu-id="0242d-168">Select a year to export products ending service in that year:</span></span>
